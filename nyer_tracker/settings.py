"""
Django settings for nyer_tracker project.
...
ALLOWED_HOSTS = ["goal-tracker-101.herokuapp.com", "127.0.0.1"]
...
ROOT_URLCONF = 'nyer_tracker.urls'
...
WSGI_APPLICATION = 'nyer_tracker.wsgi.application'
